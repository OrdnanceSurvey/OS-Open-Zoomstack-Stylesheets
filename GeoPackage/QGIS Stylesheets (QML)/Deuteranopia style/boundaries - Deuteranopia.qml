...
<qgis labelsEnabled="0" styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyMaxScale="1" minScale="1e+08" version="3.8.1-Zanzibar">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 enableorderby="0" forceraster="0" attr="type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category label="National" render="true" value="National" symbol="0"/>
    </categories>
    <symbols>
    ...
    <source-symbol>
      <symbol force_rhr="0" clip_to_extent="1" name="0" type="line" alpha="1">
        <layer class="SimpleLine" locked="0" enabled="1" pass="0">
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="86,42,147,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
