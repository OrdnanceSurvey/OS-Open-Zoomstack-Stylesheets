...
<qgis styleCategories="AllStyleCategories" minScale="1e+06" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" labelsEnabled="0" readOnly="0" maxScale="1" version="3.4.1-Madeira" simplifyDrawingTol="1" simplifyLocal="1" simplifyDrawingHints="1" simplifyAlgorithm="0">
  <flags>
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{34f44063-133c-4e3e-bfee-4f736149eda5}">
      <rule symbol="0" scalemindenom="1" filter="&quot;type&quot; = 'Local'" scalemaxdenom="40000" key="{1e1352dd-a0f1-4bca-be46-fc319944869c}" label="Local"/>
      <rule symbol="1" scalemindenom="40000" filter="&quot;type&quot; = 'District'" scalemaxdenom="200000" key="{70ae0eed-ef2a-4a25-b21e-6986505bbca7}" label="District"/>
      <rule symbol="2" scalemindenom="100000" filter="&quot;type&quot; = 'Regional'" scalemaxdenom="600000" key="{d179ed6c-078b-4ffa-92be-93d0b668b22b}" label="Regional"/>
      <rule symbol="3" scalemindenom="100000" filter="&quot;type&quot; = 'National'" scalemaxdenom="1000000" key="{1f379954-cd80-495b-aebf-292dc07cfbae}" label="National"/>
      <rule symbol="4" scalemindenom="1" filter="&quot;type&quot; = 'MHW'" scalemaxdenom="80000" key="{a118816e-65a3-436e-a702-a2397ea89de4}" label="MHW"/>
      <rule symbol="5" scalemindenom="1" filter="&quot;type&quot; = 'MLW'" scalemaxdenom="80000" key="{44e4df7b-9798-4b71-ac2f-8291110874f7}" label="MLW"/>
    </rules>
    <symbols>
      <symbol alpha="1" name="0" type="line" clip_to_extent="1">
        <layer pass="0" enabled="1" locked="0" class="SimpleLine">
          ...
          <prop k="line_color" v="4,19,38,255"/>
