...
<qgis simplifyDrawingTol="1" maxScale="80000" version="3.8.1-Zanzibar" simplifyMaxScale="1" labelsEnabled="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" minScale="5e+07" readOnly="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="1">
  <flags>
  ...
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="RuleRenderer">
    <rules key="{aeeff81f-090a-415d-a77f-255bc3a63d97}">
      <rule filter="&quot;type&quot; = 'National'" key="{588d1b64-9e49-47ff-80d3-3c29b4f35c42}" scalemaxdenom="50000000" label="National" symbol="0" scalemindenom="100000"/>
      <rule filter="&quot;type&quot; = 'Regional'" key="{090620e6-c59d-42ed-a8da-b5c76c0fe8da}" scalemaxdenom="640000" label="Regional" symbol="1" scalemindenom="80000"/>
    </rules>
    <symbols>
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="0" type="fill">
        <layer pass="0" locked="0" enabled="1" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="229,224,207,255" k="color"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory diagramOrientation="Up" height="15" scaleDependency="Area" backgroundAlpha="255" barWidth="5" rotationOffset="270" sizeType="MM" minimumSize="0" lineSizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" opacity="1" sizeScale="3x:0,0,0,0,0,0" enabled="0" penAlpha="255" penColor="#000000" backgroundColor="#ffffff" minScaleDenominator="80000" scaleBasedVisibility="0" width="15" penWidth="0" maxScaleDenominator="1e+08" lineSizeType="MM">
