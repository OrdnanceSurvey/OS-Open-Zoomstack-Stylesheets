...
<qgis styleCategories="AllStyleCategories" minScale="320000" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" labelsEnabled="1" readOnly="0" maxScale="1" version="3.4.1-Madeira" simplifyDrawingTol="1" simplifyLocal="1" simplifyDrawingHints="0" simplifyAlgorithm="0">
  <flags>
  ...
  <labeling type="simple">
    <settings>
      ...
      <placement predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidInside="0" repeatDistance="0" xOffset="3" quadOffset="5" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleIn="25" dist="0" rotationAngle="0" preserveRotation="1" maxCurvedCharAngleOut="-25" offsetType="0" yOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" priority="6" offsetUnits="MM" distUnits="MM" placement="1" placementFlags="10" repeatDistanceUnits="MM" fitInPolygonOnly="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0"/>
      <rendering drawLabels="1" upsidedownLabels="0" minFeatureSize="0" obstacle="1" fontLimitPixelSize="0" scaleMin="1" zIndex="0" maxNumLabels="2000" fontMaxPixelSize="10000" scaleVisibility="0" displayAll="0" scaleMax="10000000" labelPerPart="0" obstacleType="0" obstacleFactor="1" limitNumLabels="0" mergeLines="0" fontMinPixelSize="3"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
