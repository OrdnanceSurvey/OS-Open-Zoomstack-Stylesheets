...
<qgis styleCategories="AllStyleCategories" minScale="200000" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" labelsEnabled="1" readOnly="0" maxScale="1" version="3.4.1-Madeira" simplifyDrawingTol="1.5" simplifyLocal="1" simplifyDrawingHints="3" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{454e23cd-5439-4c68-bc0b-a15c52ea2303}">
      <rule symbol="0" filter=" &quot;level&quot; = 2" key="{509caade-54da-4d08-983d-f4e2856e9e5c}" label="Level 2">
        ...
        <rule symbol="3" scalemindenom="1" filter="&quot;type&quot; = 'Restricted'" scalemaxdenom="25000" key="{31aea799-0c58-4878-bdde-7bf336c36777}" label="Restricted"/>
      ...
      <rule symbol="6" filter=" &quot;level&quot; = 1" key="{3ffedfe6-4e05-4971-bffd-6096573e9abc}" label="Level 1">
        ...
        <rule symbol="9" scalemindenom="1" filter="&quot;type&quot; = 'Restricted'" scalemaxdenom="25000" key="{9274ddb8-74fc-4558-a28a-3e30ec32b168}" label="Restricted"/>
        <rule symbol="10" scalemindenom="1" filter="&quot;type&quot; = 'Guided Busway'" scalemaxdenom="25000" key="{b0a98638-240c-49ad-bbfa-ffd24204520e}" label="Guided Busway"/>
      ...
      <rule symbol="13" filter=" &quot;level&quot; = 0" key="{3ffedfe6-4e05-4971-bffd-6096573e9abc}" label="Level 0">
        ...
        <rule symbol="16" scalemindenom="1" filter="&quot;type&quot; = 'Restricted'" scalemaxdenom="25000" key="{de723ef7-0f9b-4d69-b2dc-1c239a27cfe0}" label="Restricted"/>
        <rule symbol="17" scalemindenom="1" filter="&quot;type&quot; = 'Guided Busway'" scalemaxdenom="25000" key="{8073fd23-84fd-458c-9757-ce2ce1aa8ad2}" label="Guided Busway"/>
      </rule>
    ...
    <symbols>
      ...
      <symbol alpha="1" name="10" type="line" clip_to_extent="1">
        ...
        <layer pass="10" enabled="1" locked="0" class="SimpleLine">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="22,38,57,255"/>
          <prop k="line_style" v="solid"/>
  ...
  <labeling type="simple">
    <settings>
      <text-style fontSizeUnit="Point" fontUnderline="0" fontSize="9" textOpacity="1" fontWordSpacing="0" fontStrikeout="0" namedStyle="Regular" blendMode="0" fontFamily="Source Sans Pro" fieldName="name" isExpression="0" fontWeight="50" useSubstitutions="0" previewBkgrdColor="#ffffff" fontCapitals="0" fontItalic="0" multilineHeight="1" textColor="104,128,145,255" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0">
        <text-buffer bufferDraw="1" bufferSizeUnits="MM" bufferOpacity="0.85" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="0" bufferColor="0,0,0,255" bufferSize="0.8" bufferJoinStyle="128" bufferBlendMode="0"/>
  ...
  <expressionfields/>
  <attributeactions>
    <defaultAction value="{44787c7f-03c1-4a0b-a8ef-97078ca6c030}" key="Canvas"/>
    <actionsetting icon="" action="" id="{44787c7f-03c1-4a0b-a8ef-97078ca6c030}" shortTitle="" capture="0" isEnabledOnlyWhenEditable="0" name="" type="0" notificationMessage="">
