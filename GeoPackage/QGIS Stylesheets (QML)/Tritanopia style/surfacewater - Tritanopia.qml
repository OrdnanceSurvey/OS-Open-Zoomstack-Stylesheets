...
<qgis simplifyDrawingTol="1" maxScale="1" version="3.8.1-Zanzibar" simplifyMaxScale="1" labelsEnabled="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" minScale="4e+06" readOnly="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="1">
  <flags>
  ...
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="RuleRenderer">
    <rules key="{1f8c30c3-6732-4d73-a159-4903ffbc67e1}">
      <rule filter="&quot;type&quot; = 'National'" key="{b3f7496d-72d0-47ce-8253-2c7710851f4d}" scalemaxdenom="4000000" label="National" symbol="0" scalemindenom="1000000"/>
      <rule filter="&quot;type&quot; = 'Regional'" key="{df903098-e869-4393-ba3a-d0ef76f7d9b6}" scalemaxdenom="1000000" label="Regional" symbol="1" scalemindenom="40000"/>
      <rule filter="&quot;type&quot; = 'Local'" key="{5402ba9e-e0f3-437a-a951-e6c04b9b558a}" scalemaxdenom="40000" label="Local" symbol="2" scalemindenom="1"/>
    </rules>
    <symbols>
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="0" type="fill">
        <layer pass="0" locked="0" enabled="1" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="88,199,233,255" k="color"/>
