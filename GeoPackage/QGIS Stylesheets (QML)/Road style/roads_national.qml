  ...
  <renderer-v2 symbollevels="1" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{454e23cd-5439-4c68-bc0b-a15c52ea2303}">
      <rule symbol="0" filter=" &quot;level&quot; = 2" key="{509caade-54da-4d08-983d-f4e2856e9e5c}" label="Level 2">
        <rule symbol="1" scalemindenom="1" filter="&quot;type&quot; = 'Motorway'" scalemaxdenom="25000" key="{11c8fe02-c64b-414f-8a3a-8738e3521cd2}" label="Motorway"/>
        <rule symbol="2" scalemindenom="1" filter="&quot;type&quot; = 'Primary'" scalemaxdenom="25000" key="{2c5750cc-3368-4ec4-ad58-cf39e7ecc9f3}" label="Primary"/>
        <rule symbol="3" scalemindenom="1" filter="&quot;type&quot; = 'Motorway'" scalemaxdenom="25000" key="{a651c0b2-67d4-4e00-b1f7-9599a85460e1}" label="Motorway case"/>
        <rule symbol="4" scalemindenom="1" filter="&quot;type&quot; = 'Primary'" scalemaxdenom="25000" key="{462cca7c-fa1d-423f-8b41-ef9f93574d1a}" label="Primary case"/>
      </rule>
      <rule symbol="5" filter=" &quot;level&quot; = 1" key="{3ffedfe6-4e05-4971-bffd-6096573e9abc}" label="Level 1">
        <rule symbol="6" scalemindenom="1" filter="&quot;type&quot; = 'Motorway'" scalemaxdenom="25000" key="{b3e3165d-bbcf-4a8b-9a00-86e90159b3bf}" label="Motorway"/>
        <rule symbol="7" scalemindenom="1" filter="&quot;type&quot; = 'Primary'" scalemaxdenom="25000" key="{0a53f6e4-12c6-4f1b-bcd9-eb291652d930}" label="Primary"/>
        <rule symbol="8" scalemindenom="1" filter="&quot;type&quot; = 'Motorway'" scalemaxdenom="25000" key="{403e7bb6-7cd9-48ef-a7af-96fb659859d3}" label="Motorway case"/>
        <rule symbol="9" scalemindenom="1" filter="&quot;type&quot; = 'Primary'" scalemaxdenom="25000" key="{876fec5c-5ee7-4148-baa9-66d3c9d83803}" label="Primary case"/>
      </rule>
      <rule symbol="10" filter=" &quot;level&quot; = 0" key="{3ffedfe6-4e05-4971-bffd-6096573e9abc}" label="Level 0">
        <rule symbol="11" scalemindenom="1" filter="&quot;type&quot; = 'Motorway'" scalemaxdenom="25000" key="{80c93d2b-98d4-4cd0-8ac8-8d12865ed63b}" label="Motorway"/>
        <rule symbol="12" scalemindenom="1" filter="&quot;type&quot; = 'Primary'" scalemaxdenom="25000" key="{ba3e7c84-6d3f-4ad3-91c9-e5b328fd9e7b}" label="Primary"/>
        <rule symbol="13" scalemindenom="1" filter="&quot;type&quot; = 'Motorway'" scalemaxdenom="25000" key="{db17c723-59f4-4579-97e7-404cf711ba07}" label="Motorway case"/>
        <rule symbol="14" scalemindenom="1" filter="&quot;type&quot; = 'Primary'" scalemaxdenom="25000" key="{5223eb8a-2253-483c-8871-13954e36d354}" label="Primary case"/>
      </rule>
      <rule symbol="15" key="{9e01e0f1-82f4-48eb-8980-8afc36c33105}" label="Mid-scale Roads">
        <rule symbol="16" scalemindenom="25000" filter="&quot;type&quot; = 'Motorway'" scalemaxdenom="5000000" key="{16ed1e8a-b309-433e-bd52-d2cf4e81f526}" label="Motorway"/>
        <rule symbol="17" scalemindenom="25000" filter="&quot;type&quot; = 'Primary'" scalemaxdenom="5000000" key="{3ad8d6ec-c123-4190-8b9c-edad9a55db22}" label="Primary"/>
      </rule>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" name="12" type="line" clip_to_extent="1">
        <layer pass="5" enabled="1" locked="0" class="SimpleLine">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="55,194,86,255"/>
          <prop k="line_style" v="solid"/>
        ...
        <Option type="Map">
          ...
          <Option name="properties" type="Map">
            <Option name="BufferColor" type="Map">
              ...
              <Option value="CASE &#xd;&#xa;WHEN  &quot;type&quot; = 'Motorway' THEN  '#06B1CA'&#xd;&#xa;WHEN  &quot;type&quot; = 'Primary' THEN  '#37C256'&#xd;&#xa;END" name="expression" type="QString"/>
