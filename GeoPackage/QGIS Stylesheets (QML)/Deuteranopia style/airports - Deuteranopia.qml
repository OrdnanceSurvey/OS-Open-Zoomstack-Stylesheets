...
<qgis labelsEnabled="1" styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" hasScaleBasedVisibilityFlag="1" maxScale="1" simplifyDrawingHints="0" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyMaxScale="1" minScale="320000" version="3.8.1-Zanzibar">
  <flags>
    ...
    <symbols>
      <symbol force_rhr="0" clip_to_extent="1" name="0" type="marker" alpha="1">
        <layer class="SvgMarker" locked="0" enabled="1" pass="0">
          <prop v="0" k="angle"/>
          <prop v="51,48,141,255" k="color"/>
          <prop v="0" k="fixedAspectRatio"/>
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="os-open-zoomstack-symbols/Airport.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <labeling type="simple">
    <settings>
      ...
      <text-format multilineAlign="3" placeDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" rightDirectionSymbol=">" decimals="3" plussign="0" autoWrapLength="0" formatNumbers="0" leftDirectionSymbol="&lt;" addDirectionSymbol="0" reverseDirectionSymbol="0" wrapChar=""/>
      <placement maxCurvedCharAngleOut="-25" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" yOffset="0" priority="6" quadOffset="5" geometryGeneratorType="PointGeometry" preserveRotation="1" rotationAngle="0" centroidInside="0" fitInPolygonOnly="0" offsetType="0" distUnits="MM" placementFlags="10" maxCurvedCharAngleIn="25" repeatDistance="0" dist="0" centroidWhole="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" offsetUnits="MM" xOffset="3" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorEnabled="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placement="1" geometryGenerator=""/>
      <rendering drawLabels="1" scaleMin="1" obstacleType="0" fontMaxPixelSize="10000" obstacleFactor="1" scaleVisibility="0" labelPerPart="0" fontLimitPixelSize="0" limitNumLabels="0" obstacle="1" maxNumLabels="2000" zIndex="0" mergeLines="0" minFeatureSize="0" fontMinPixelSize="3" displayAll="0" scaleMax="10000000" upsidedownLabels="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" type="QString" value=""/>
          <Option name="properties"/>
  ...
  <DiagramLayerSettings showAll="1" priority="0" dist="0" placement="0" zIndex="0" obstacle="0" linePlacementFlags="18">
    <properties>
      <Option type="Map">
        <Option name="name" type="QString" value=""/>
        <Option name="properties"/>
