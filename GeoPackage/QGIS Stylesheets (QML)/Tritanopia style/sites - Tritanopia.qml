...
<qgis simplifyDrawingTol="1" maxScale="1" version="3.8.1-Zanzibar" simplifyMaxScale="1" labelsEnabled="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" minScale="160000" readOnly="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="1">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" attr="type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category value="Air Transport" label="Air Transport" render="true" symbol="0"/>
      <category value="Education" label="Education" render="true" symbol="1"/>
      <category value="Medical Care" label="Medical Care" render="true" symbol="2"/>
      <category value="Road Transport" label="Road Transport" render="true" symbol="3"/>
      <category value="Water Transport" label="Water Transport" render="true" symbol="4"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="1" type="fill">
        <layer pass="0" locked="0" enabled="1" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="247,221,176,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
      ...
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="2" type="fill">
        <layer pass="0" locked="0" enabled="1" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="255,155,187,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
      ...
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="3" type="fill">
        <layer pass="0" locked="0" enabled="1" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="246,186,130,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
      ...
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="4" type="fill">
        <layer pass="0" locked="0" enabled="1" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="226,236,246,255" k="color"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
