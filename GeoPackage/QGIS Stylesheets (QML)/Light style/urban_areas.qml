...
<qgis styleCategories="AllStyleCategories" minScale="5e+07" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" labelsEnabled="0" readOnly="0" maxScale="80000" version="3.4.1-Madeira" simplifyDrawingTol="1" simplifyLocal="1" simplifyDrawingHints="1" simplifyAlgorithm="0">
  <flags>
  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{aeeff81f-090a-415d-a77f-255bc3a63d97}">
      <rule symbol="0" scalemindenom="100000" filter="&quot;type&quot; = 'National'" scalemaxdenom="50000000" key="{588d1b64-9e49-47ff-80d3-3c29b4f35c42}" label="National"/>
      <rule symbol="1" scalemindenom="80000" filter="&quot;type&quot; = 'Regional'" scalemaxdenom="640000" key="{090620e6-c59d-42ed-a8da-b5c76c0fe8da}" label="Regional"/>
    </rules>
    <symbols>
      <symbol alpha="1" name="0" type="fill" clip_to_extent="1">
        <layer pass="0" enabled="1" locked="0" class="SimpleFill">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="230,229,225,255"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory barWidth="5" scaleBasedVisibility="0" sizeScale="3x:0,0,0,0,0,0" minScaleDenominator="80000" enabled="0" maxScaleDenominator="1e+08" sizeType="MM" lineSizeType="MM" lineSizeScale="3x:0,0,0,0,0,0" height="15" scaleDependency="Area" width="15" penColor="#000000" penAlpha="255" opacity="1" backgroundColor="#ffffff" labelPlacementMethod="XHeight" minimumSize="0" backgroundAlpha="255" penWidth="0" rotationOffset="270" diagramOrientation="Up">
