...
<qgis simplifyDrawingTol="1" maxScale="1" version="3.8.1-Zanzibar" simplifyMaxScale="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" minScale="320000" readOnly="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="1">
  <flags>
  ...
  <labeling type="simple">
    <settings>
      ...
      <placement geometryGenerator="" placement="1" dist="0" distUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" preserveRotation="1" xOffset="3" fitInPolygonOnly="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" quadOffset="5" offsetUnits="MM" priority="6" geometryGeneratorEnabled="0" offsetType="0" repeatDistanceUnits="MM" placementFlags="10" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidInside="0" yOffset="0" centroidWhole="0" maxCurvedCharAngleOut="-25" maxCurvedCharAngleIn="25" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry"/>
      <rendering fontLimitPixelSize="0" zIndex="0" displayAll="0" limitNumLabels="0" minFeatureSize="0" scaleMax="10000000" fontMinPixelSize="3" obstacleFactor="1" drawLabels="1" scaleVisibility="0" labelPerPart="0" fontMaxPixelSize="10000" maxNumLabels="2000" upsidedownLabels="0" obstacle="1" mergeLines="0" obstacleType="0" scaleMin="1"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
