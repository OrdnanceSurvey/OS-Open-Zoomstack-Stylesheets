...
<qgis hasScaleBasedVisibilityFlag="1" maxScale="1" simplifyLocal="1" simplifyMaxScale="1" simplifyDrawingHints="0" minScale="40000" styleCategories="AllStyleCategories" simplifyDrawingTol="1" version="3.16.2-Hannover" labelsEnabled="1" simplifyAlgorithm="0" readOnly="0">
  <flags>
  ...
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="categorizedSymbol" attr="type">
    <categories>
      <category value="Light Rapid Transit Station" symbol="0" label="Light Rapid Transit Station" render="true"/>
      <category value="Light Rapid Transit Station And London Underground Station" symbol="1" label="Light Rapid Transit Station And London Underground Station" render="true"/>
      <category value="Light Rapid Transit Station And Railway Station" symbol="2" label="Light Rapid Transit Station And Railway Station" render="true"/>
      <category value="London Underground Station" symbol="3" label="London Underground Station" render="true"/>
      <category value="Railway Station" symbol="4" label="Railway Station" render="true"/>
      <category value="Railway Station And London Underground Station" symbol="5" label="Railway Station And London Underground Station" render="true"/>
    </categories>
    <symbols>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textColor="0,0,0,255" fontWeight="50" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontLetterSpacing="0" fontStrikeout="0" fontKerning="1" fontSize="9" textOpacity="1" multilineHeight="1" fontItalic="0" fontSizeUnit="Point" allowHtml="0" useSubstitutions="0" capitalization="0" isExpression="0" fontUnderline="0" textOrientation="horizontal" fieldName="name" previewBkgrdColor="255,255,255,255" namedStyle="Regular" blendMode="0" fontFamily="Source Sans Pro" fontWordSpacing="0">
        <text-buffer bufferOpacity="0.80000000000000004" bufferDraw="1" bufferBlendMode="0" bufferNoFill="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="244,244,238,255" bufferJoinStyle="128" bufferSize="0.80000000000000004" bufferSizeUnits="MM"/>
      ...
      <text-format plussign="0" autoWrapLength="0" useMaxLineLengthForAutoWrap="1" addDirectionSymbol="0" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" multilineAlign="3" placeDirectionSymbol="0" formatNumbers="0" reverseDirectionSymbol="0" decimals="3" wrapChar=""/>
      <placement rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" lineAnchorPercent="0.5" centroidWhole="0" xOffset="0" distUnits="MM" repeatDistanceUnits="MM" overrunDistance="0" polygonPlacementFlags="2" geometryGeneratorEnabled="0" geometryGenerator="" distMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="1" geometryGeneratorType="PointGeometry" dist="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidInside="0" priority="5" repeatDistance="0" layerType="PointGeometry" maxCurvedCharAngleOut="-25" offsetUnits="MM" preserveRotation="1" overrunDistanceUnit="MM" placementFlags="10" maxCurvedCharAngleIn="25" quadOffset="7" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" yOffset="1" lineAnchorType="0"/>
      <rendering fontMaxPixelSize="10000" minFeatureSize="0" mergeLines="0" obstacleType="0" fontMinPixelSize="3" zIndex="0" upsidedownLabels="0" labelPerPart="0" scaleVisibility="1" scaleMin="1" obstacleFactor="0.59999999999999998" obstacle="1" fontLimitPixelSize="0" scaleMax="30000" maxNumLabels="2000" drawLabels="1" displayAll="0" limitNumLabels="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" value="" name="name"/>
          <Option name="properties"/>
