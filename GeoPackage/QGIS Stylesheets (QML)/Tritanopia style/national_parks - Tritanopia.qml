...
<qgis simplifyDrawingTol="1" maxScale="40000" version="3.8.1-Zanzibar" simplifyMaxScale="1" labelsEnabled="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" minScale="5e+07" readOnly="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="1">
  <flags>
    ...
    <symbols>
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="0" type="fill">
        <layer pass="0" locked="0" enabled="1" class="SimpleFill">
          ...
          <prop v="230,240,215,255" k="color"/>
