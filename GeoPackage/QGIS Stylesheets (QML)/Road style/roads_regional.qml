  ...
  <renderer-v2 symbollevels="1" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{454e23cd-5439-4c68-bc0b-a15c52ea2303}">
      ...
      <rule symbol="6" filter=" &quot;level&quot; = 1" key="{3ffedfe6-4e05-4971-bffd-6096573e9abc}" label="Level 1">
        <rule symbol="7" scalemindenom="1" filter="&quot;type&quot; = 'B Road'" scalemaxdenom="25000" key="{1bcecbba-abaa-4b98-9d9e-d7c3ac11cad8}" label="B Road"/>
      ...
      <rule symbol="11" filter=" &quot;level&quot; = 0" key="{3ffedfe6-4e05-4971-bffd-6096573e9abc}" label="Level 0">
        ...
        <rule symbol="13" scalemindenom="1" filter="&quot;type&quot; = 'A Road'" scalemaxdenom="25000" key="{e38014d7-a3ea-4b04-bcbe-6a8670803cb6}" label="A Road"/>
        <rule symbol="14" scalemindenom="1" filter="&quot;type&quot; = 'B Road'" scalemaxdenom="25000" key="{1fd4dd8c-b9c7-4a52-be46-a88d4c71fcac}" label="B Road case"/>
        <rule symbol="15" scalemindenom="1" filter="&quot;type&quot; = 'A Road'" scalemaxdenom="25000" key="{b9c86228-3c2f-4034-9323-6ddbfc8950ae}" label="A Road case"/>
      </rule>
      <rule symbol="16" key="{9e01e0f1-82f4-48eb-8980-8afc36c33105}" label="Mid-scale Roads">
        <rule symbol="17" scalemindenom="25000" filter="&quot;type&quot; = 'B Road'" scalemaxdenom="640000" key="{ac3f366c-5f02-4af3-8b77-8208128d9972}" label="B Road"/>
        <rule symbol="18" scalemindenom="25000" filter="&quot;type&quot; = 'A Road'" scalemaxdenom="1000000" key="{9b033ca7-9b61-49db-85a6-188288ad18be}" label="A Road"/>
      </rule>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" name="13" type="line" clip_to_extent="1">
        <layer pass="5" enabled="1" locked="0" class="SimpleLine">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="255,136,157,255"/>
          <prop k="line_style" v="solid"/>
  ...
  <labeling type="simple">
    <settings>
      <text-style fontSizeUnit="Point" fontUnderline="0" fontSize="8.5" textOpacity="1" fontWordSpacing="0" fontStrikeout="0" namedStyle="Regular" blendMode="0" fontFamily="Source Sans Pro" fieldName="number" isExpression="0" fontWeight="50" useSubstitutions="0" previewBkgrdColor="#ffffff" fontCapitals="0" fontItalic="0" multilineHeight="1" textColor="36,36,36,255" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0">
        <text-buffer bufferDraw="1" bufferSizeUnits="MM" bufferOpacity="0.85" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="0" bufferColor="255,255,255,255" bufferSize="0.9" bufferJoinStyle="128" bufferBlendMode="0"/>
