...
<qgis styleCategories="AllStyleCategories" minScale="200000" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" labelsEnabled="1" readOnly="0" maxScale="0" version="3.4.1-Madeira" simplifyDrawingTol="1.5" simplifyLocal="1" simplifyDrawingHints="3" simplifyAlgorithm="0">
  <flags>
  ...
  <renderer-v2 symbollevels="1" forceraster="0" type="RuleRenderer" enableorderby="1">
    <rules key="{454e23cd-5439-4c68-bc0b-a15c52ea2303}">
      <rule symbol="0" filter=" &quot;level&quot; = 2" key="{509caade-54da-4d08-983d-f4e2856e9e5c}" label="Level 2">
        <rule symbol="1" scalemindenom="1" filter="&quot;type&quot; = 'Minor'" scalemaxdenom="40000" key="{a7819b1d-b312-44e0-adf6-8f6d01499527}" label="Minor"/>
        <rule symbol="2" scalemindenom="1" filter="&quot;type&quot; = 'Local'" scalemaxdenom="40000" key="{49842030-120b-4a0e-88f9-291f2351cda6}" label="Local"/>
        <rule symbol="3" scalemindenom="1" filter="&quot;type&quot; = 'Restricted'" scalemaxdenom="25000" key="{559e40e1-6863-4721-8477-fac6768d3d9b}" label="Restricted"/>
        ...
        <rule symbol="6" scalemindenom="1" filter="&quot;type&quot; = 'Restricted'" scalemaxdenom="40000" key="{a0a47ebb-12ef-4588-a6f0-b033d1d5fbd8}" label="Restricted case"/>
      </rule>
      <rule symbol="7" filter=" &quot;level&quot; = 1" key="{3ffedfe6-4e05-4971-bffd-6096573e9abc}" label="Level 1">
        <rule symbol="8" scalemindenom="1" filter="&quot;type&quot; = 'Minor'" scalemaxdenom="40000" key="{2e1ef5eb-a4fc-42e7-8214-57ed03126a2a}" label="Minor"/>
        <rule symbol="9" scalemindenom="1" filter="&quot;type&quot; = 'Local'" scalemaxdenom="40000" key="{d6e05cfa-dbee-4508-af7c-7927c3c7031a}" label="Local"/>
        <rule symbol="10" scalemindenom="1" filter="&quot;type&quot; = 'Restricted'" scalemaxdenom="25000" key="{1c3a79c1-b6e9-47aa-b350-2638553a3180}" label="Restricted"/>
        <rule symbol="11" scalemindenom="1" filter="&quot;type&quot; = 'Guided Busway'" scalemaxdenom="25000" key="{c4b08f9d-4e5b-46c6-a0d4-5f1fb6a8a238}" label="Guided Busway"/>
        <rule symbol="12" scalemindenom="1" filter="&quot;type&quot; = 'Minor'" scalemaxdenom="40000" key="{7ba3bb0c-ba8e-405b-a93e-54ab84f0f53a}" label="Minor case"/>
        <rule symbol="13" scalemindenom="1" filter="&quot;type&quot; = 'Local'" scalemaxdenom="40000" key="{00eb87a4-3935-4be2-81e6-97e25b10891b}" label="Local case"/>
        <rule symbol="14" scalemindenom="1" filter="&quot;type&quot; = 'Restricted'" scalemaxdenom="40000" key="{23b598d6-30e9-4dff-9d54-8fbe0eb5c126}" label="Restricted case"/>
      </rule>
      <rule symbol="15" filter=" &quot;level&quot; = 0" key="{3ffedfe6-4e05-4971-bffd-6096573e9abc}" label="Level 0">
        <rule symbol="16" scalemindenom="1" filter="&quot;type&quot; = 'Minor'" scalemaxdenom="40000" key="{42707639-1106-4f56-876d-8f09c2238ac4}" label="Minor"/>
        <rule symbol="17" scalemindenom="1" filter="&quot;type&quot; = 'Local'" scalemaxdenom="40000" key="{190bc87c-fd0a-498e-b5df-4efaad0233ab}" label="Local"/>
        <rule symbol="18" scalemindenom="1" filter="&quot;type&quot; = 'Restricted'" scalemaxdenom="25000" key="{dede2ff2-cee6-4632-8648-a2e9d3e0736c}" label="Restricted"/>
        <rule symbol="19" scalemindenom="1" filter="&quot;type&quot; = 'Guided Busway'" scalemaxdenom="25000" key="{e457b6a1-10ee-47df-9dcf-53e92e1ecaae}" label="Guided Busway"/>
        <rule symbol="20" scalemindenom="1" filter="&quot;type&quot; = 'Minor'" scalemaxdenom="40000" key="{7ec3e071-62ba-4935-9be8-969bf2157d4b}" label="Minor case"/>
        <rule symbol="21" scalemindenom="1" filter="&quot;type&quot; = 'Local'" scalemaxdenom="40000" key="{42c07f46-0761-446a-a5e9-929bc7bfb2a3}" label="Local case"/>
        <rule symbol="22" scalemindenom="1" filter="&quot;type&quot; = 'Restricted'" scalemaxdenom="25000" key="{6f62ee3b-d6c2-48f0-870e-be02141ee80e}" label="Restricted case"/>
      </rule>
      <rule symbol="23" key="{9e01e0f1-82f4-48eb-8980-8afc36c33105}" label="Mid-scale Roads">
        <rule symbol="24" scalemindenom="40000" filter="&quot;type&quot; = 'Minor'" scalemaxdenom="200000" key="{adc09698-c877-4b14-afdb-bde03e5828b0}" label="Minor"/>
      </rule>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" name="1" type="line" clip_to_extent="1">
        <layer pass="22" enabled="1" locked="0" class="SimpleLine">
          ...
          <prop k="line_color" v="254,242,180,255"/>
      ...
      <symbol alpha="1" name="10" type="line" clip_to_extent="1">
        <layer pass="14" enabled="1" locked="0" class="SimpleLine">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="226,226,226,255"/>
          <prop k="line_style" v="solid"/>
      ...
      <symbol alpha="1" name="2" type="line" clip_to_extent="1">
        <layer pass="21" enabled="1" locked="0" class="SimpleLine">
          <prop k="capstyle" v="round"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="customdash_unit" v="MapUnit"/>
      ...
      <symbol alpha="1" name="20" type="line" clip_to_extent="1">
      ...
      <symbol alpha="1" name="21" type="line" clip_to_extent="1">
      ...
      <symbol alpha="1" name="22" type="line" clip_to_extent="1">
      ...
      <symbol alpha="1" name="23" type="line" clip_to_extent="1">
        <layer pass="0" enabled="1" locked="0" class="SimpleLine">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol alpha="1" name="24" type="line" clip_to_extent="1">
        <layer pass="0" enabled="1" locked="0" class="SimpleLine">
          <prop k="capstyle" v="round"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol alpha="1" name="3" type="line" clip_to_extent="1">
        <layer pass="20" enabled="1" locked="0" class="SimpleLine">
          <prop k="capstyle" v="round"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="customdash_unit" v="MapUnit"/>
  ...
  <labeling type="simple">
    <settings>
      ...
      <rendering drawLabels="1" upsidedownLabels="0" minFeatureSize="0" obstacle="1" fontLimitPixelSize="0" scaleMin="1" zIndex="0" maxNumLabels="2000" fontMaxPixelSize="10000" scaleVisibility="1" displayAll="0" scaleMax="70000" labelPerPart="0" obstacleType="0" obstacleFactor="1" limitNumLabels="0" mergeLines="1" fontMinPixelSize="3"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
  ...
  <expressionfields/>
  <attributeactions>
    <defaultAction value="{4094c2bc-74fa-4c15-a755-67f94d9fef74}" key="Canvas"/>
    <actionsetting icon="" action="" id="{4094c2bc-74fa-4c15-a755-67f94d9fef74}" shortTitle="" capture="0" isEnabledOnlyWhenEditable="0" name="" type="0" notificationMessage="">
