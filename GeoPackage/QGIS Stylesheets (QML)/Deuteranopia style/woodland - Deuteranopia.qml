...
<qgis labelsEnabled="0" styleCategories="AllStyleCategories" simplifyLocal="1" readOnly="0" hasScaleBasedVisibilityFlag="1" maxScale="1" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyMaxScale="1" minScale="2e+06" version="3.8.1-Zanzibar">
  <flags>
  ...
  <renderer-v2 enableorderby="0" forceraster="0" symbollevels="0" type="RuleRenderer">
    <rules key="{001b7f7d-ab3c-404b-9da7-e71af45adc80}">
      <rule label="National" key="{956cd1d8-2730-4049-8c8b-fd68b1e9ecc2}" filter="&quot;type&quot; = 'National'" scalemindenom="320000" symbol="0" scalemaxdenom="2000000"/>
      <rule label="Regional" key="{1c198f3b-c08a-46a7-a591-aeae0548f2a5}" filter="&quot;type&quot; = 'Regional'" scalemindenom="80000" symbol="1" scalemaxdenom="320000"/>
      <rule label="Local" key="{085df146-13e5-4e9d-a10f-990ff252ff8f}" filter="&quot;type&quot; = 'Local'" scalemindenom="1" symbol="2" scalemaxdenom="80000"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" clip_to_extent="1" name="0" type="fill" alpha="1">
        <layer class="SimpleFill" locked="0" enabled="1" pass="0">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="190,234,161,255" k="color"/>
