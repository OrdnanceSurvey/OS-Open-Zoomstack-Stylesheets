...
<qgis styleCategories="AllStyleCategories" minScale="5e+06" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" labelsEnabled="1" readOnly="0" maxScale="1" version="3.4.1-Madeira" simplifyDrawingTol="1.5" simplifyLocal="1" simplifyDrawingHints="3" simplifyAlgorithm="0">
  ...
  <labeling type="simple">
    <settings>
      <text-style fontSizeUnit="Point" fontUnderline="0" fontSize="10" textOpacity="1" fontWordSpacing="0" fontStrikeout="0" namedStyle="Regular" blendMode="0" fontFamily="Source Sans Pro" fieldName="number" isExpression="0" fontWeight="50" useSubstitutions="0" previewBkgrdColor="#ffffff" fontCapitals="0" fontItalic="0" multilineHeight="1" textColor="104,128,145,255" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0">
        <text-buffer bufferDraw="1" bufferSizeUnits="MM" bufferOpacity="0.75" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="0" bufferColor="0,0,0,255" bufferSize="0.8" bufferJoinStyle="128" bufferBlendMode="0"/>
