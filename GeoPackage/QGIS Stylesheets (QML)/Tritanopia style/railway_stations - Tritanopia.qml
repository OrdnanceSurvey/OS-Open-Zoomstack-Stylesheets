...
<qgis simplifyDrawingTol="1" maxScale="1" version="3.8.1-Zanzibar" simplifyMaxScale="1" labelsEnabled="1" simplifyDrawingHints="0" styleCategories="AllStyleCategories" simplifyAlgorithm="0" minScale="40000" readOnly="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="1">
  <flags>
    <Identifiable>1</Identifiable>
    <Removable>1</Removable>
    <Searchable>1</Searchable>
  </flags>
  <renderer-v2 forceraster="0" enableorderby="0" attr="type" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category value="Light Rapid Transit Station" label="Light Rapid Transit Station" render="true" symbol="0"/>
      <category value="Light Rapid Transit Station And London Underground Station" label="Light Rapid Transit Station And London Underground Station" render="true" symbol="1"/>
      <category value="Light Rapid Transit Station And Railway Station" label="Light Rapid Transit Station And Railway Station" render="true" symbol="2"/>
      <category value="London Underground Station" label="London Underground Station" render="true" symbol="3"/>
      <category value="Railway Station" label="Railway Station" render="true" symbol="4"/>
      <category value="Railway Station And London Underground Station" label="Railway Station And London Underground Station" render="true" symbol="5"/>
    </categories>
    <symbols>
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="0" type="marker">
        <layer pass="0" locked="0" enabled="1" class="SvgMarker">
          ...
          <prop v="os-open-zoomstack-symbols/LRTS.svg" k="name"/>
          <prop v="0,0" k="offset"/>
      ...
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="1" type="marker">
        <layer pass="0" locked="0" enabled="1" class="SvgMarker">
          ...
          <prop v="0" k="fixedAspectRatio"/>
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="os-open-zoomstack-symbols/LRTS-UG.svg" k="name"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="0,0,0,255" k="outline_color"/>
      ...
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="2" type="marker">
        <layer pass="0" locked="0" enabled="1" class="SvgMarker">
          ...
          <prop v="0" k="fixedAspectRatio"/>
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="os-open-zoomstack-symbols/RS-LRTS.svg" k="name"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="0,0,0,255" k="outline_color"/>
      ...
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="3" type="marker">
        <layer pass="0" locked="0" enabled="1" class="SvgMarker">
          ...
          <prop v="0" k="fixedAspectRatio"/>
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="os-open-zoomstack-symbols/UG.svg" k="name"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="0,0,0,255" k="outline_color"/>
      ...
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="4" type="marker">
        <layer pass="0" locked="0" enabled="1" class="SvgMarker">
          ...
          <prop v="0" k="fixedAspectRatio"/>
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="os-open-zoomstack-symbols/RS.svg" k="name"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="0,0,0,255" k="outline_color"/>
      ...
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="5" type="marker">
        <layer pass="0" locked="0" enabled="1" class="SvgMarker">
          ...
          <prop v="0" k="fixedAspectRatio"/>
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="os-open-zoomstack-symbols/RS-UG.svg" k="name"/>
          <prop v="0,0" k="offset"/>
          <prop v="3x:0,0,0,0,0,0" k="offset_map_unit_scale"/>
          <prop v="MM" k="offset_unit"/>
          <prop v="0,0,0,255" k="outline_color"/>
  ...
  <labeling type="simple">
    <settings>
      <text-style fontWordSpacing="0" multilineHeight="1" namedStyle="Regular" fontSizeUnit="Point" useSubstitutions="0" textColor="48,48,48,255" blendMode="0" fontCapitals="0" fontItalic="0" textOpacity="1" previewBkgrdColor="#ffffff" fontSize="9" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontStrikeout="0" isExpression="0" fontUnderline="0" fontLetterSpacing="0" fontFamily="Source Sans Pro" fieldName="name" fontWeight="50">
        <text-buffer bufferJoinStyle="128" bufferOpacity="0.8" bufferSize="0.8" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferColor="244,244,238,255" bufferNoFill="0" bufferDraw="1" bufferSizeUnits="MM" bufferBlendMode="0"/>
      ...
      <text-format plussign="0" useMaxLineLengthForAutoWrap="1" rightDirectionSymbol=">" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" autoWrapLength="0" wrapChar="" decimals="3" addDirectionSymbol="0" multilineAlign="3" placeDirectionSymbol="0" formatNumbers="0"/>
      <placement geometryGenerator="" placement="1" dist="0" distUnits="MM" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" preserveRotation="1" xOffset="0" fitInPolygonOnly="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" rotationAngle="0" quadOffset="7" offsetUnits="MM" priority="5" geometryGeneratorEnabled="0" offsetType="0" repeatDistanceUnits="MM" placementFlags="10" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidInside="0" yOffset="1" centroidWhole="0" maxCurvedCharAngleOut="-25" maxCurvedCharAngleIn="25" distMapUnitScale="3x:0,0,0,0,0,0" geometryGeneratorType="PointGeometry"/>
      <rendering fontLimitPixelSize="0" zIndex="0" displayAll="0" limitNumLabels="0" minFeatureSize="0" scaleMax="30000" fontMinPixelSize="3" obstacleFactor="0.6" drawLabels="1" scaleVisibility="1" labelPerPart="0" fontMaxPixelSize="10000" maxNumLabels="2000" upsidedownLabels="0" obstacle="1" mergeLines="0" obstacleType="0" scaleMin="1"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
