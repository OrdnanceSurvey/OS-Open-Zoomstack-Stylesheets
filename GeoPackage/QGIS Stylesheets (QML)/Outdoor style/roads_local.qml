...
<qgis styleCategories="AllStyleCategories" minScale="200000" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="1" labelsEnabled="1" readOnly="0" maxScale="0" version="3.4.1-Madeira" simplifyDrawingTol="1.5" simplifyLocal="1" simplifyDrawingHints="3" simplifyAlgorithm="0">
  ...
  <renderer-v2 symbollevels="1" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{454e23cd-5439-4c68-bc0b-a15c52ea2303}">
      <rule symbol="0" filter=" &quot;level&quot; = 2" key="{509caade-54da-4d08-983d-f4e2856e9e5c}" label="Level 2">
        ...
        <rule symbol="3" scalemindenom="1" filter="&quot;type&quot; = 'Restricted'" scalemaxdenom="25000" key="{a77e3ce4-27d8-44a2-befb-d0f614865baa}" label="Restricted"/>
      ...
      <rule symbol="6" filter=" &quot;level&quot; = 1" key="{3ffedfe6-4e05-4971-bffd-6096573e9abc}" label="Level 1">
        ...
        <rule symbol="9" scalemindenom="1" filter="&quot;type&quot; = 'Restricted'" scalemaxdenom="25000" key="{700b2eb8-fb47-42e8-9a4d-8c52b9821806}" label="Restricted"/>
        <rule symbol="10" scalemindenom="1" filter="&quot;type&quot; = 'Guided Busway'" scalemaxdenom="25000" key="{a1a8ff78-56be-403e-9d11-04e277b456f0}" label="Guided Busway"/>
      ...
      <rule symbol="13" filter=" &quot;level&quot; = 0" key="{3ffedfe6-4e05-4971-bffd-6096573e9abc}" label="Level 0">
        ...
        <rule symbol="16" scalemindenom="1" filter="&quot;type&quot; = 'Restricted'" scalemaxdenom="25000" key="{52116584-7f02-4077-a4ba-ac3633944f2c}" label="Restricted"/>
        <rule symbol="17" scalemindenom="1" filter="&quot;type&quot; = 'Guided Busway'" scalemaxdenom="25000" key="{ec4e8d81-ed5f-4ea2-827e-40e2f6422e7f}" label="Guided Busway"/>
      </rule>
  ...
  <expressionfields/>
  <attributeactions>
    <defaultAction value="{78937a53-6b25-4e98-b4f9-77f448531a29}" key="Canvas"/>
    <actionsetting icon="" action="" id="{78937a53-6b25-4e98-b4f9-77f448531a29}" shortTitle="" capture="0" isEnabledOnlyWhenEditable="0" name="" type="0" notificationMessage="">
