...
<qgis simplifyDrawingTol="1" maxScale="1" version="3.8.1-Zanzibar" simplifyMaxScale="1" labelsEnabled="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" simplifyAlgorithm="0" minScale="2e+06" readOnly="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="1">
  <flags>
  ...
  <renderer-v2 forceraster="0" enableorderby="0" symbollevels="0" type="RuleRenderer">
    <rules key="{001b7f7d-ab3c-404b-9da7-e71af45adc80}">
      <rule filter="&quot;type&quot; = 'National'" key="{956cd1d8-2730-4049-8c8b-fd68b1e9ecc2}" scalemaxdenom="2000000" label="National" symbol="0" scalemindenom="320000"/>
      <rule filter="&quot;type&quot; = 'Regional'" key="{1c198f3b-c08a-46a7-a591-aeae0548f2a5}" scalemaxdenom="320000" label="Regional" symbol="1" scalemindenom="80000"/>
      <rule filter="&quot;type&quot; = 'Local'" key="{085df146-13e5-4e9d-a10f-990ff252ff8f}" scalemaxdenom="80000" label="Local" symbol="2" scalemindenom="1"/>
    </rules>
    <symbols>
      <symbol alpha="1" force_rhr="0" clip_to_extent="1" name="0" type="fill">
        <layer pass="0" locked="0" enabled="1" class="SimpleFill">
          <prop v="3x:0,0,0,0,0,0" k="border_width_map_unit_scale"/>
          <prop v="201,228,184,255" k="color"/>
